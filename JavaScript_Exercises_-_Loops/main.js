...
for (let i = 1; i <= numOfMeals; i++) {
  var proteinItem =
    proteinArray[Math.floor(Math.random() * proteinArray.length)];
  var grainItem = grainArray[Math.floor(Math.random() * grainArray.length)];
  var vegetableItem =
    vegetableArray[Math.floor(Math.random() * vegetableArray.length)];
  var beverageItem =
    beverageArray[Math.floor(Math.random() * beverageArray.length)];
  var dessertItem =
    dessertArray[Math.floor(Math.random() * dessertArray.length)];
